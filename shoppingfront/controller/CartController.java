...
@RequestMapping("shippTheItems")
public String ShippTheItems(Principal p, Model model) {

	List<Ship> shippingList = shipService.getByEmail(p.getName());
	model.addAttribute("shippingList", shippingList);
	model.addAttribute("isUserClickedshippTheItems", "true");
	return "User";
...
public String afterEditSup(@ModelAttribute Ship ship, Principal p) {
	Customer customer = customerService.getUsersByEmail(p.getName());
	ship.setCustomerEmail(p.getName());
...
return"User";
 ...
 @RequestMapping("YetToCome")
 public String YetToCome(Model m) {
		m.addAttribute("isUserClickedYetToCome", "true");
		return "YetToCome";
 }
 }
