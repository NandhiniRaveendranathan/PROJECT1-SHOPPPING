...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="categoryName" name="categoryName" placeholder="Fashion">
  </div>
  <div class="form-group">
    <label for="catDesc">Product Description</label>
    <input type="text" class="form-control" id="categoryDesc" name="categoryDesc" placeholder="Trendy Designs">
